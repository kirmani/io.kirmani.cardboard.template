...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        ByteBuffer bbFloorNormals =
            ByteBuffer.allocateDirect(WorldLayoutData.FLOOR_NORMALS.length * 4);
        ...
        ByteBuffer bbFloorColors =
            ByteBuffer.allocateDirect(WorldLayoutData.FLOOR_COLORS.length * 4);
    ...
    public void onCardboardTrigger() {
        ...
        overlayView.show3DToast("You tapped the screen!");
